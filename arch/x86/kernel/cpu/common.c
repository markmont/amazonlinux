...
/* CPU is affected by gather data sampling */
#define GDS		BIT(6)
...
static const struct x86_cpu_id cpu_vuln_blacklist[] __initconst = {
	...
	VULNBL_INTEL_STEPPINGS(SKYLAKE_L,	X86_STEPPING_ANY,		SRBDS | MMIO | RETBLEED | GDS),
	VULNBL_INTEL_STEPPINGS(SKYLAKE_X,	X86_STEPPING_ANY,		MMIO | RETBLEED | GDS),
	VULNBL_INTEL_STEPPINGS(SKYLAKE,		X86_STEPPING_ANY,		SRBDS | MMIO | RETBLEED | GDS),
	...
	VULNBL_AMD(0x17, RETBLEED | SMT_RSB | RAS_POISONING),
